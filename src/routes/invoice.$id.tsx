...
type ItemRow = { id: number; productName: string; qty: string; uom: string; unitPrice: string; currency?: string; lineAmount: string; itemNo?: string; shelfLife?: string; requestedETD?: string };
...
const INVOICE_PROFILES: Record<string, InvoiceProfile> = {
  ...
  // ---- Symrise Asia Pacific (9910148696) — 7 POs, no Sales Contract, Stage 2 in progress ----
  "9910148696": {
    stage: "Stage 2",
    infoData: {
      "Invoice": {
        header: [
          { key: "Invoice Number", value: "9910148696" },
          ...
          { key: "Payment Term", value: "60 DAYS AFTER DATE OF INVOICE" },
          { key: "Total Amount", value: "351,241.20" },
          { key: "Total Quantity", value: "16,200.000" },
          { key: "Quantity UoM", value: "KG" },
          { key: "Net Weight", value: "16,200.000" },
          { key: "Transport Mode", value: "SEA - SELF PICK UP" },
          { key: "Shipment Route", value: "SINGAPORE PORT -> HO CHI MINH PORT", wide: true },
        ],
        bank: [
          { key: "Beneficiary Name", value: "SYMRISE ASIA PACIFIC PTE LTD", wide: true },
          { key: "Bank Name", value: "DEUTSCHE BANK AG, SINGAPORE - ONE RAFFLES QUAY #17-00 SOUTH TOWER SINGAPORE 048583", wide: true },
          { key: "SWIFT/BIC", value: "DEUTSGSG" },
          { key: "Bank Account", value: "2519262-05-5 (USD)" },
        ],
        items: [
          { id: 20, productName: "RADIANT BOUQUET DC -180 KG", qty: "360.000", uom: "KG", unitPrice: "12.62", lineAmount: "4,543.20" },
          { id: 110, productName: "OPTAMINT® HARMONY -180 KG", qty: "1,080.000", uom: "KG", unitPrice: "24.65", lineAmount: "26,622.00" },
          { id: 120, productName: "OPTAMINT® HARMONY -180 KG", qty: "1,620.000", uom: "KG", unitPrice: "24.65", lineAmount: "39,933.00" },
          { id: 121, productName: "ISLAND MOOD -180 KG", qty: "540.000", uom: "KG", unitPrice: "15.14", lineAmount: "8,175.60" },
          { id: 122, productName: "GINGER THERAPY -180 KG", qty: "360.000", uom: "KG", unitPrice: "20.04", lineAmount: "7,214.40" },
          { id: 123, productName: "OPTAMINT® ARTISAN WHITE -180 KG", qty: "180.000", uom: "KG", unitPrice: "20.18", lineAmount: "3,632.40" },
          { id: 124, productName: "OPTAMINT® GREEN PARADISE -180 KG", qty: "900.000", uom: "KG", unitPrice: "18.80", lineAmount: "16,920.00" },
          { id: 125, productName: "OPTAMINT® -180 KG", qty: "540.000", uom: "KG", unitPrice: "37.94", lineAmount: "20,487.60" },
          { id: 126, productName: "OPTAMINT® CREAMYLICIOUS STRAWBERRY -180 KG", qty: "180.000", uom: "KG", unitPrice: "23.04", lineAmount: "4,147.20" },
          { id: 127, productName: "OPTAMINT® ARTISAN WHITE -180 KG", qty: "180.000", uom: "KG", unitPrice: "20.18", lineAmount: "3,632.40" },
          { id: 128, productName: "OPTAMINT® QI-CON -180 KG", qty: "900.000", uom: "KG", unitPrice: "26.93", lineAmount: "24,237.00" },
          { id: 129, productName: "OPTAMINT RUBY EMBRACE II -180 KG", qty: "900.000", uom: "KG", unitPrice: "12.03", lineAmount: "10,827.00" },
          { id: 130, productName: "OPTAMINT® -180 KG", qty: "2,340.000", uom: "KG", unitPrice: "23.99", lineAmount: "56,136.60" },
          { id: 131, productName: "OPTAMINT® -180 KG", qty: "1,440.000", uom: "KG", unitPrice: "23.99", lineAmount: "34,545.60" },
          { id: 132, productName: "OPTAMINT® QI-CON -180 KG", qty: "1,620.000", uom: "KG", unitPrice: "26.93", lineAmount: "43,626.60" },
          { id: 133, productName: "OPTAMINT® GREEN PARADISE -180 KG", qty: "1,440.000", uom: "KG", unitPrice: "18.80", lineAmount: "27,072.00" },
          { id: 134, productName: "OPTAMINT RUBY EMBRACE II -180 KG", qty: "1,620.000", uom: "KG", unitPrice: "12.03", lineAmount: "19,488.60" },
        ],
      },
      "Bill of Lading": {
        header: [
          { key: "B/L Number", value: "SE2603021", mono: true },
          { key: "Transport Mode", value: "SEA" },
          ...
          { key: "Place of Receipt", value: "SINGAPORE" },
          { key: "Port of Loading", value: "SINGAPORE" },
          { key: "Port of Discharge", value: "HO CHI MINH CITY" },
          { key: "Place of Delivery", value: "TAN CANG HIEP PHUOC" },
          { key: "Incoterms", value: "—" },
          { key: "Freight Term", value: "FREIGHT PREPAID" },
          { key: "Laden On Board", value: "2026-03-26" },
          { key: "B/L Issue", value: "2026-03-26" },
          { key: "Gross Weight", value: "18,494.350 KGS" },
          { key: "Measurement", value: "27.090 M3" },
          { key: "Total Packages", value: "23 PALLETS (90 DRUMS) / 1 x 40'HC CONTAINER" },
          { key: "Container / Seal No.", value: "SKYU8123088 / ASA12288", wide: true },
          { key: "Total Net Weight", value: "16,200.000 KG" },
          { key: "HS Code", value: "33029000" },
          { key: "DG Class / UN No.", value: "IMO CLASS 9 / UN 3082 (ENVIRONMENTALLY HAZARDOUS SUBSTANCE, LIQUID, N.O.S.)", wide: true },
          { key: "Country of Origin", value: "—" },
        ],
        goods: [
          { id: 1, description: "OPTAMINT® ARTISAN WHITE -180 KG (2 DRUMS, item 249693)", netWeight: "—", grossWeight: "—" },
          { id: 2, description: "OPTAMINT® GREEN PARADISE -180 KG (13 DRUMS, item 413083)", netWeight: "—", grossWeight: "—" },
          { id: 3, description: "OPTAMINT® -180 KG (3 DRUMS, item 293032)", netWeight: "—", grossWeight: "—" },
          { id: 4, description: "OPTAMINT® CREAMYLICIOUS STRAWBERRY -180 KG (1 DRUM, item 327595)", netWeight: "—", grossWeight: "—" },
          { id: 5, description: "OPTAMINT® QUI-GON -180 KG (14 DRUMS, item 417477)", netWeight: "—", grossWeight: "—" },
          { id: 6, description: "OPTAMINT RUBY EMBRACE II -180 KG (14 DRUMS, item 187419)", netWeight: "—", grossWeight: "—" },
          { id: 7, description: "OPTAMINT® -180 KG (21 DRUMS, item 293247)", netWeight: "—", grossWeight: "—" },
          { id: 8, description: "RADIANT BOUQUET DC -180 KG (2 STEEL DRUMS, item 119877)", netWeight: "—", grossWeight: "—" },
          { id: 9, description: "OPTAMINT® HARMONY -180 KG (15 STEEL DRUMS, item 280511)", netWeight: "—", grossWeight: "—" },
          { id: 10, description: "ISLAND MOOD -180 KG (3 STEEL DRUMS, item 791362)", netWeight: "—", grossWeight: "—" },
          { id: 11, description: "GINGER THERAPY -180 KG (2 STEEL DRUMS, item 849996)", netWeight: "—", grossWeight: "18,494.350 KGS (total, incl. pallets/packaging)" },
        ],
      },
    },
    purchaseOrders: [
      {
        id: "po-1",
        label: "26020253",
        fileUrl: "/pdfs/Purchase_Order_Symrise_26020253.pdf",
        data: {
          header: [
            ...
            { key: "Currency", value: "USD" },
            { key: "Incoterm", value: "EXW (Incoterms 2020)" },
            { key: "Incoterm Location", value: "" },
            { key: "Shipment Mode", value: "SEA" },
            { key: "Port of Discharge", value: "" },
            { key: "Payment Term", value: "TT 60 days from invoice date" },
            { key: "Requested ETD", value: "2026-03-13 / 2026-03-20" },
            { key: "Total Quantity", value: "2,520.00" },
            { key: "Total Amount", value: "30,315.60" },
          ],
          bank: [
            { key: "Beneficiary Name", value: "SYMRISE ASIA PACIFIC PTE LTD", wide: true },
            { key: "Bank Name", value: "DEUTSCHE BANK AG, SOUTH TOWER", wide: true },
            { key: "SWIFT/BIC", value: "DEUTSGSG" },
            { key: "Bank Account", value: "2519262055" },
          ],
          items: [
            { id: 1, itemNo: "65542100", productName: "187419 OPTAMINT RUBY EMBRACE II - 180 KG/Drum", shelfLife: "12 months", qty: "1,620.00", uom: "KG", unitPrice: "12.0300", currency: "USD", requestedETD: "2026-03-13", lineAmount: "19,488.60" },
            { id: 2, itemNo: "65542100", productName: "187419 OPTAMINT RUBY EMBRACE II - 180 KG/Drum", shelfLife: "12 months", qty: "900.00", uom: "KG", unitPrice: "12.0300", currency: "USD", requestedETD: "2026-03-20", lineAmount: "10,827.00" },
          ],
        },
      },
      {
        id: "po-2",
        label: "26010762",
        fileUrl: "/pdfs/Purchase_Order_Symrise_26010762.pdf",
        data: {
          header: [
            ...
            { key: "Currency", value: "USD" },
            { key: "Incoterm", value: "EXW (Incoterms 2020)" },
            { key: "Incoterm Location", value: "SINGAPORE" },
            { key: "Shipment Mode", value: "SEA" },
            { key: "Port of Discharge", value: "HO CHI MINH PORT" },
            { key: "Payment Term", value: "TT 60 days from invoice date" },
            { key: "Requested ETD", value: "2026-03-06 / 2026-03-13" },
            { key: "Total Quantity", value: "7,560.00" },
            { key: "Total Amount", value: "210,605.40" },
          ],
          bank: [
            { key: "Beneficiary Name", value: "SYMRISE ASIA PACIFIC PTE LTD", wide: true },
            { key: "Bank Name", value: "DEUTSCHE BANK AG, SOUTH TOWER", wide: true },
          ...
          items: [
            { id: 1, itemNo: "65553016", productName: "249693 OPTAMINT ARTISAN WHITE - 180 KG/Drum", shelfLife: "12 months", qty: "180.00", uom: "KG", unitPrice: "20.1800", currency: "USD", requestedETD: "2026-03-13", lineAmount: "3,632.40" },
            { id: 2, itemNo: "69780362", productName: "633335 OPTAMINT RAINBOW MINT - 180 KG/Drum", shelfLife: "12 months", qty: "6,480.00", uom: "KG", unitPrice: "28.2000", currency: "USD", requestedETD: "2026-03-06", lineAmount: "182,736.00" },
            { id: 3, itemNo: "62754355", productName: "417477 OPTAMINT QUI-GON - 180 KG/Drum", shelfLife: "12 months", qty: "900.00", uom: "KG", unitPrice: "26.9300", currency: "USD", requestedETD: "2026-03-13", lineAmount: "24,237.00" },
          ],
        },
      },
      {
        id: "po-3",
        label: "26010579",
        fileUrl: "/pdfs/Purchase_Order_Symrise_26010579.pdf",
        data: {
          header: [
            ...
            { key: "Port of Discharge", value: "HO CHI MINH PORT" },
            { key: "Payment Term", value: "TT 60 days from invoice date" },
            { key: "Requested ETD", value: "2026-03-13" },
            { key: "Total Quantity", value: "540.00" },
            { key: "Total Amount", value: "8,175.60" },
          ],
          bank: [
            { key: "Beneficiary Name", value: "SYMRISE ASIA PACIFIC PTE LTD", wide: true },
            { key: "Bank Name", value: "DEUTSCHE BANK AG, SOUTH TOWER", wide: true },
          ...
          items: [
            { id: 1, itemNo: "67946086", productName: "791362 ISLAND MOOD - 180 KG/Drum", shelfLife: "12 months", qty: "540.00", uom: "KG", unitPrice: "15.1400", currency: "USD", requestedETD: "2026-03-13", lineAmount: "8,175.60" },
          ],
        },
      },
      {
        id: "po-4",
        label: "26010578",
        fileUrl: "/pdfs/Purchase_Order_Symrise_26010578.pdf",
        data: {
          header: [
            ...
            { key: "Port of Discharge", value: "HO CHI MINH PORT" },
            { key: "Payment Term", value: "TT 60 days from invoice date" },
            { key: "Requested ETD", value: "2026-03-06 / 2026-03-20" },
            { key: "Total Quantity", value: "720.00" },
            { key: "Total Amount", value: "14,428.80" },
          ],
          bank: [
            { key: "Beneficiary Name", value: "SYMRISE ASIA PACIFIC PTE LTD", wide: true },
            { key: "Bank Name", value: "DEUTSCHE BANK AG, SOUTH TOWER", wide: true },
          ...
          items: [
            { id: 1, itemNo: "64938505", productName: "849996 GINGER THERAPY - 180 KG/Drum", shelfLife: "12 months", qty: "360.00", uom: "KG", unitPrice: "20.0400", currency: "USD", requestedETD: "2026-03-06", lineAmount: "7,214.40" },
            { id: 2, itemNo: "64938505", productName: "849996 GINGER THERAPY - 180 KG/Drum", shelfLife: "12 months", qty: "360.00", uom: "KG", unitPrice: "20.0400", currency: "USD", requestedETD: "2026-03-20", lineAmount: "7,214.40" },
          ],
        },
      },
      {
        id: "po-5",
        label: "26010468",
        fileUrl: "/pdfs/Purchase_Order_Symrise_26010468.pdf",
        data: {
          header: [
            ...
            { key: "Payment Term", value: "TT 60 days from invoice date" },
            { key: "Requested ETD", value: "2026-03-06 / 2026-03-20" },
            { key: "Total Quantity", value: "1,080.00" },
            { key: "Total Amount", value: "17,737.20" },
          ],
          bank: [
            { key: "Beneficiary Name", value: "SYMRISE ASIA PACIFIC PTE LTD", wide: true },
            { key: "Bank Name", value: "DEUTSCHE BANK AG, SOUTH TOWER", wide: true },
          ...
          items: [
            { id: 1, itemNo: "64005524", productName: "234927 OPTAMINT FOR MOUTHCARE - 180 KG/Drum", shelfLife: "12 months", qty: "900.00", uom: "KG", unitPrice: "15.1000", currency: "USD", requestedETD: "2026-03-06", lineAmount: "13,590.00" },
            { id: 2, itemNo: "68186353", productName: "327595 OPTAMINT CREAMYLICIOUS STRAWBERRY - 180 KG/Drum", shelfLife: "12 months", qty: "180.00", uom: "KG", unitPrice: "23.0400", currency: "USD", requestedETD: "2026-03-20", lineAmount: "4,147.20" },
          ],
        },
      },
      {
        id: "po-6",
        label: "26010318",
        fileUrl: "/pdfs/Purchase_Order_Symrise_26010318.pdf",
        data: {
          header: [
            ...
            { key: "Port of Discharge", value: "HO CHI MINH PORT" },
            { key: "Payment Term", value: "TT 60 days from invoice date" },
            { key: "Requested ETD", value: "2026-03-20" },
            { key: "Total Quantity", value: "540.00" },
            { key: "Total Amount", value: "20,487.60" },
          ],
          bank: [
            { key: "Beneficiary Name", value: "SYMRISE ASIA PACIFIC PTE LTD", wide: true },
            { key: "Bank Name", value: "DEUTSCHE BANK AG, SOUTH TOWER", wide: true },
          ...
          items: [
            { id: 1, itemNo: "62875003", productName: "293032 OPTAMINT - 180 KG/Drum", shelfLife: "12 months", qty: "540.00", uom: "KG", unitPrice: "37.9400", currency: "USD", requestedETD: "2026-03-20", lineAmount: "20,487.60" },
          ],
        },
      },
      {
        id: "po-7",
        label: "26010089",
        fileUrl: "/pdfs/Purchase_Order_Symrise_26010089.pdf",
        data: {
          header: [
            ...
            { key: "Port of Discharge", value: "CAT LAI PORT" },
            { key: "Payment Term", value: "TT 60 days from invoice date" },
            { key: "Requested ETD", value: "2026-02-27 / 2026-03-13 / 2026-03-20" },
            { key: "Total Quantity", value: "12,960.00" },
            { key: "Total Amount", value: "287,364.60" },
          ],
          bank: [
            { key: "Beneficiary Name", value: "SYMRISE ASIA PACIFIC PTE LTD", wide: true },
            { key: "Bank Name", value: "DEUTSCHE BANK AG, SOUTH TOWER", wide: true },
          ...
          items: [
            { id: 1, itemNo: "64779241", productName: "119877 RADIANT BOUQUET DC - 180 KG/Drum", shelfLife: "12 months", qty: "360.00", uom: "KG", unitPrice: "12.6200", currency: "USD", requestedETD: "2026-02-27", lineAmount: "4,543.20" },
            { id: 2, itemNo: "64779241", productName: "119877 RADIANT BOUQUET DC - 180 KG/Drum", shelfLife: "12 months", qty: "360.00", uom: "KG", unitPrice: "12.6200", currency: "USD", requestedETD: "2026-03-13", lineAmount: "4,543.20" },
            { id: 3, itemNo: "65553016", productName: "249693 OPTAMINT ARTISAN WHITE - 180 KG/Drum", shelfLife: "12 months", qty: "180.00", uom: "KG", unitPrice: "20.1800", currency: "USD", requestedETD: "2026-03-13", lineAmount: "3,632.40" },
            { id: 4, itemNo: "64005521", productName: "293247 OPTAMINT - 180 KG/Drum", shelfLife: "12 months", qty: "2,340.00", uom: "KG", unitPrice: "23.9900", currency: "USD", requestedETD: "2026-03-13", lineAmount: "56,136.60" },
            { id: 5, itemNo: "64005521", productName: "293247 OPTAMINT - 180 KG/Drum", shelfLife: "12 months", qty: "1,440.00", uom: "KG", unitPrice: "23.9900", currency: "USD", requestedETD: "2026-03-20", lineAmount: "34,545.60" },
            { id: 6, itemNo: "62754355", productName: "417477 OPTAMINT QUI-GON - 180 KG/Drum", shelfLife: "12 months", qty: "1,620.00", uom: "KG", unitPrice: "26.9300", currency: "USD", requestedETD: "2026-03-20", lineAmount: "43,626.60" },
            { id: 7, itemNo: "20279949", productName: "413083 OPTAMINT GREEN PARADISE - 180 KG/Drum", shelfLife: "12 months", qty: "1,440.00", uom: "KG", unitPrice: "18.8000", currency: "USD", requestedETD: "2026-02-27", lineAmount: "27,072.00" },
            { id: 8, itemNo: "20279949", productName: "413083 OPTAMINT GREEN PARADISE - 180 KG/Drum", shelfLife: "12 months", qty: "900.00", uom: "KG", unitPrice: "18.8000", currency: "USD", requestedETD: "2026-03-13", lineAmount: "16,920.00" },
            { id: 9, itemNo: "20279949", productName: "413083 OPTAMINT GREEN PARADISE - 180 KG/Drum", shelfLife: "12 months", qty: "1,440.00", uom: "KG", unitPrice: "18.8000", currency: "USD", requestedETD: "2026-03-20", lineAmount: "27,072.00" },
            { id: 10, itemNo: "64005524", productName: "234927 OPTAMINT FOR MOUTHCARE - 180 KG/Drum", shelfLife: "12 months", qty: "180.00", uom: "KG", unitPrice: "15.1000", currency: "USD", requestedETD: "2026-03-20", lineAmount: "2,718.00" },
            { id: 11, itemNo: "68475444", productName: "280511 OPTAMINT HARMONY - 180 KG/Drum", shelfLife: "12 months", qty: "1,080.00", uom: "KG", unitPrice: "24.6500", currency: "USD", requestedETD: "2026-03-13", lineAmount: "26,622.00" },
            { id: 12, itemNo: "68475444", productName: "280511 OPTAMINT HARMONY - 180 KG/Drum", shelfLife: "12 months", qty: "1,620.00", uom: "KG", unitPrice: "24.6500", currency: "USD", requestedETD: "2026-03-20", lineAmount: "39,933.00" },
          ],
        },
      },
    ],
    salesContracts: [],
    customsHeaderFields: [
      { key: "Declaration Number", value: "108113574700", mono: true },
      { key: "Type Code", value: "A11" },
      ...
      { key: "Invoice Number", value: "A - 9910148696" },
      { key: "Invoice Issue Date", value: "2026-03-18" },
      { key: "Invoice Value", value: "351,241.2 USD" },
      { key: "Incoterms", value: "EXW" },
      { key: "Payment Method", value: "KC" },
      { key: "Payment Term", value: "T/T" },
      { key: "Gross Weight", value: "18,494.35 KGM" },
      { key: "Cargo Arrival Date", value: "2026-03-28" },
      { key: "Exchange Rate", value: "26,137" },
      { key: "Transport Means", value: "KOTA NAZIM V.0211N" },
      { key: "Loading Location", value: "SINGAPORE" },
      { key: "Unloading Location", value: "TAN CANG HIEP PHUOC" },
      { key: "Taxable Value Total", value: "9,278,200,479.4001 VND" },
      { key: "VAT Amount Total", value: "742,256,038 VND" },
    ],
    customsItems: [
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 119877 RADIANT BOUQUET DC", qty: "360", uom: "KGM", unitPrice: "12.62", invoiceValue: "4,543.2", taxableValueVnd: "120,010,751.6374", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "9,600,860.131" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 280511 OPTAMINT HARMONY", qty: "1,080", uom: "KGM", unitPrice: "24.65", invoiceValue: "26,622", taxableValueVnd: "703,232,573.9765", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "56,258,605.9181" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 280511 OPTAMINT HARMONY", qty: "1,620", uom: "KGM", unitPrice: "24.65", invoiceValue: "39,933", taxableValueVnd: "1,054,848,860.9647", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "84,387,908.8772" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 791362 ISLAND MOOD", qty: "540", uom: "KGM", unitPrice: "15.14", invoiceValue: "8,175.6", taxableValueVnd: "215,962,295.5376", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "17,276,983.643" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 849996 GINGER THERAPY", qty: "360", uom: "KGM", unitPrice: "20.04", invoiceValue: "7,214.4", taxableValueVnd: "190,571,748.2419", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "15,245,739.8594" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 249693 OPTAMINT ARTISAN WHITE", qty: "180", uom: "KGM", unitPrice: "20.18", invoiceValue: "3,632.4", taxableValueVnd: "95,951,543.9002", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "7,676,123.512" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 413083 OPTAMINT GREEN PARADISE", qty: "900", uom: "KGM", unitPrice: "18.8", invoiceValue: "16,920", taxableValueVnd: "446,949,708.9506", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "35,755,976.716" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 293032 OPTAMINT", qty: "540", uom: "KGM", unitPrice: "37.94", invoiceValue: "20,487.6", taxableValueVnd: "541,189,530.5612", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "43,295,162.4449" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 327595 OPTAMINT CREAMYLICIOUS STRAWBERRY", qty: "180", uom: "KGM", unitPrice: "23.04", invoiceValue: "4,147.2", taxableValueVnd: "109,550,226.5343", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "8,764,018.1227" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 249693 OPTAMINT ARTISAN WHITE", qty: "180", uom: "KGM", unitPrice: "20.18", invoiceValue: "3,632.4", taxableValueVnd: "95,951,543.9002", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "7,676,123.512" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 417477 OPTAMINT QUI-GON", qty: "900", uom: "KGM", unitPrice: "26.93", invoiceValue: "24,237", taxableValueVnd: "640,231,684.151", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "51,218,534.7321" },
      { hsCode: "33029000", description: "Nguyên liệu sản xuất hóa mỹ phẩm 187419 OPTAMINT RUBY EMBRACE II", qty: "900", uom: "KGM", unitPrice: "12.03", invoiceValue: "10,827", taxableValueVnd: "286,000,265.887", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "22,880,021.271" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 293247 OPTAMINT", qty: "2,340", uom: "KGM", unitPrice: "23.99", invoiceValue: "56,136.6", taxableValueVnd: "1,482,874,529.047", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "118,629,962.3238" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 293247 OPTAMINT", qty: "1,440", uom: "KGM", unitPrice: "23.99", invoiceValue: "34,545.6", taxableValueVnd: "912,538,171.7212", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "73,003,053.7377" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 417477 OPTAMINT QUI-GON", qty: "1,620", uom: "KGM", unitPrice: "26.93", invoiceValue: "43,626.6", taxableValueVnd: "1,152,417,031.4718", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "92,193,362.5177" },
      { hsCode: "33029000", description: "Nguyên liệu hóa mỹ phẩm - Hương liệu tổng hợp 413083 OPTAMINT GREEN PARADISE", qty: "1,440", uom: "KGM", unitPrice: "18.8", invoiceValue: "27,072", taxableValueVnd: "715,119,534.3209", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "57,209,562.7457" },
      { hsCode: "33029000", description: "Nguyên liệu sản xuất hóa mỹ phẩm 187419 OPTAMINT RUBY EMBRACE II", qty: "1,620", uom: "KGM", unitPrice: "12.03", invoiceValue: "19,488.6", taxableValueVnd: "514,800,478.5966", importTaxPct: "0", importTaxVnd: "0", vatPct: "8", vatVnd: "41,184,038.2877" },
    ],
    pdfMap: {
      "Invoice": "/pdfs/Invoice_Symrise.pdf",
      "Bill of Lading": "/pdfs/Bill_of_Lading_Symrise.pdf",
      "Customs Declaration": "/pdfs/Customs_Declaration_Symrise.pdf",
    },
    stageDocs: {
      "Stage 1": [
        { label: "Purchase Order", docNo: "26020253" },
        { label: "Purchase Order", docNo: "26010762" },
        { label: "Purchase Order", docNo: "26010579" },
        { label: "Purchase Order", docNo: "26010578" },
        { label: "Purchase Order", docNo: "26010468" },
        { label: "Purchase Order", docNo: "26010318" },
        { label: "Purchase Order", docNo: "26010089" },
        { label: "Bill of Lading", docNo: "SE2603021" },
      ],
      "Stage 2": [
        { label: "Purchase Order", docNo: "26020253" },
        { label: "Purchase Order", docNo: "26010762" },
        ...
        { label: "Purchase Order", docNo: "26010089" },
        { label: "Bill of Lading", docNo: "SE2603021" },
        { label: "Customs Declaration", docNo: "108113574700" },
      ],
      "Stage 3": [
        { label: "Purchase Order", docNo: "26020253" },
        { label: "Purchase Order", docNo: "26010762" },
    ...
    stageBanners: {
      "Stage 1": [
        { text: "Matching Stage 1 completed — Invoice ↔ PO ↔ BL reconciled. 100% matched.", tone: "success" },
        { text: "Le Thi Hoa confirmed at 09:40 on 28-Mar-2026", tone: "success" },
      ],
      "Stage 2": [
        { text: "Matching Stage 2 completed — Customs Declaration added. All header + item lines matched.", tone: "success" },
      ],
    ...
    headerMatchRows: [
      ...
      ["Contract Number", "Không áp dụng", "Không áp dụng", "Không áp dụng", "—", "—", "—"],
      ["Currency", "USD", "USD", "—", "—", "USD", "—"],
      ["Incoterm", "EXW Singapore", "EXW Singapore", "—", "—", "EXW", "—"],
      ["Payment Term", "TT 60D Invoice", "TT 60D Invoice", "—", "—", "—", "—"],
      ["Bank", "Deutsche Bank Singapore", "Deutsche Bank Singapore", "—", "—", "—", "—"],
      ["Shipment / Vessel", "KOTA NAZIM 0211N", "—", "—", "KOTA NAZIM 0211N", "KOTA NAZIM V.0211N", "—"],
      ["Container", "1 x 40'HC", "—", "—", "1 x 40'HC", "—", "—"],
    ...
    itemMatchLines: [
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "360.000", unitPrice: "12.62", lineAmount: "4,543.20" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010089", qty: "360.00", unitPrice: "12.6200", lineAmount: "4,543.20" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "360.000", unitPrice: "12.62", lineAmount: "4,543.20" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "360", unitPrice: "12.62", lineAmount: "4,543.2" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "1,080.000", unitPrice: "24.65", lineAmount: "26,622.00" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010089", qty: "1,080.00", unitPrice: "24.6500", lineAmount: "26,622.00" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "1,080.000", unitPrice: "24.65", lineAmount: "26,622.00" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "1,080", unitPrice: "24.65", lineAmount: "26,622" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "1,620.000", unitPrice: "24.65", lineAmount: "39,933.00" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010089", qty: "1,620.00", unitPrice: "24.6500", lineAmount: "39,933.00" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "1,620.000", unitPrice: "24.65", lineAmount: "39,933.00" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "1,620", unitPrice: "24.65", lineAmount: "39,933" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "540.000", unitPrice: "15.14", lineAmount: "8,175.60" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010579", qty: "540.00", unitPrice: "15.1400", lineAmount: "8,175.60" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "540.000", unitPrice: "15.14", lineAmount: "8,175.60" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "540", unitPrice: "15.14", lineAmount: "8,175.6" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "360.000", unitPrice: "20.04", lineAmount: "7,214.40" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010578", qty: "360.00", unitPrice: "20.0400", lineAmount: "7,214.40" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "360.000", unitPrice: "20.04", lineAmount: "7,214.40" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "360", unitPrice: "20.04", lineAmount: "7,214.4" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "180.000", unitPrice: "20.18", lineAmount: "3,632.40" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010762", qty: "180.00", unitPrice: "20.1800", lineAmount: "3,632.40" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "180.000", unitPrice: "20.18", lineAmount: "3,632.40" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "180", unitPrice: "20.18", lineAmount: "3,632.4" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "900.000", unitPrice: "18.80", lineAmount: "16,920.00" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010089", qty: "900.00", unitPrice: "18.8000", lineAmount: "16,920.00" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "900.000", unitPrice: "18.80", lineAmount: "16,920.00" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "900", unitPrice: "18.8", lineAmount: "16,920" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "540.000", unitPrice: "37.94", lineAmount: "20,487.60" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010318", qty: "540.00", unitPrice: "37.9400", lineAmount: "20,487.60" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "540.000", unitPrice: "37.94", lineAmount: "20,487.60" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "540", unitPrice: "37.94", lineAmount: "20,487.6" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "180.000", unitPrice: "23.04", lineAmount: "4,147.20" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010468", qty: "180.00", unitPrice: "23.0400", lineAmount: "4,147.20" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "180.000", unitPrice: "23.04", lineAmount: "4,147.20" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "180", unitPrice: "23.04", lineAmount: "4,147.2" },
          ],
          "Stage 3": [],
        },
      },
      ...
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "900.000", unitPrice: "26.93", lineAmount: "24,237.00" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010762", qty: "900.00", unitPrice: "26.9300", lineAmount: "24,237.00" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "900.000", unitPrice: "26.93", lineAmount: "24,237.00" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "900", unitPrice: "26.93", lineAmount: "24,237" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "900.000", unitPrice: "12.03", lineAmount: "10,827.00" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26020253", qty: "900.00", unitPrice: "12.0300", lineAmount: "10,827.00" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "900.000", unitPrice: "12.03", lineAmount: "10,827.00" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "900", unitPrice: "12.03", lineAmount: "10,827" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "2,340.000", unitPrice: "23.99", lineAmount: "56,136.60" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010089", qty: "2,340.00", unitPrice: "23.9900", lineAmount: "56,136.60" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "2,340.000", unitPrice: "23.99", lineAmount: "56,136.60" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "2,340", unitPrice: "23.99", lineAmount: "56,136.6" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "1,440.000", unitPrice: "23.99", lineAmount: "34,545.60" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010089", qty: "1,440.00", unitPrice: "23.9900", lineAmount: "34,545.60" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "1,440.000", unitPrice: "23.99", lineAmount: "34,545.60" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "1,440", unitPrice: "23.99", lineAmount: "34,545.6" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "1,620.000", unitPrice: "26.93", lineAmount: "43,626.60" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010089", qty: "1,620.00", unitPrice: "26.9300", lineAmount: "43,626.60" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "1,620.000", unitPrice: "26.93", lineAmount: "43,626.60" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "1,620", unitPrice: "26.93", lineAmount: "43,626.6" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "1,440.000", unitPrice: "18.80", lineAmount: "27,072.00" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26010089", qty: "1,440.00", unitPrice: "18.8000", lineAmount: "27,072.00" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "1,440.000", unitPrice: "18.80", lineAmount: "27,072.00" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "1,440", unitPrice: "18.8", lineAmount: "27,072" },
          ],
          "Stage 3": [],
        },
      },
      {
        ...
        matchedDocs: {
          "Stage 1": [
            ...
            { label: "Bill of Lading", docNo: "SE2603021", qty: "1,620.000", unitPrice: "12.03", lineAmount: "19,488.60" },
          ],
          "Stage 2": [
            { label: "Purchase Order", docNo: "26020253", qty: "1,620.00", unitPrice: "12.0300", lineAmount: "19,488.60" },
            { label: "Bill of Lading", docNo: "SE2603021", qty: "1,620.000", unitPrice: "12.03", lineAmount: "19,488.60" },
            { label: "Customs Declaration", docNo: "108113574700", qty: "1,620", unitPrice: "12.03", lineAmount: "19,488.6" },
          ],
          "Stage 3": [],
        },
      },
    ...
    activityEvents: [
      { date: "05-Jan", t: "09:00", icon: FileDown, title: "Purchase Order synchronized", who: "System · Vendor Portal", desc: "PO 26010089 received from vendor portal." },
      { date: "13-Jan", t: "09:00", icon: FileDown, title: "Purchase Order synchronized", who: "System · Vendor Portal", desc: "PO 26010318 received from vendor portal." },
      { date: "16-Jan", t: "09:00", icon: FileDown, title: "Purchase Order synchronized", who: "System · Vendor Portal", desc: "PO 26010468 received from vendor portal." },
      { date: "20-Jan", t: "09:00", icon: FileDown, title: "Purchase Order synchronized", who: "System · Vendor Portal", desc: "PO 26010578 and PO 26010579 received from vendor portal." },
      { date: "26-Jan", t: "09:00", icon: FileDown, title: "Purchase Order synchronized", who: "System · Vendor Portal", desc: "PO 26010762 received from vendor portal." },
      { date: "10-Feb", t: "09:00", icon: FileDown, title: "Purchase Order synchronized", who: "System · Vendor Portal", desc: "PO 26020253 received from vendor portal." },
      { date: "18-Mar", t: "10:00", icon: FileDown, title: "Commercial Invoice synchronized", who: "System", desc: "Invoice 9910148696 downloaded from vendor portal." },
      { date: "26-Mar", t: "14:00", icon: FileDown, title: "Bill of Lading synchronized", who: "System · Freight Forwarder", desc: "BL SE2603021 received." },
      { date: "27-Mar", t: "08:15", icon: ScanText, title: "OCR completed", who: "System · OCR Engine v3.1", desc: "Structured extraction on documents · fields captured." },
      { date: "28-Mar", t: "09:05", icon: GitCompareArrows, title: "Matching Stage 1 completed", who: "System", desc: "Invoice ↔ PO ↔ BL reconciled. 100% matched." },
      { date: "02-Apr", t: "16:13", icon: Landmark, title: "Customs Declaration synchronized", who: "System · VNACCS", desc: "Customs declaration 108113574700 linked." },
      { date: "03-Apr", t: "09:10", icon: Clock, title: "Matching Stage 2 in progress", who: "System", desc: "Customs Declaration added, pending Finance approval." },
    ],
    activityHeaderLabel: "{n} events",
    approverName: "Le Thi Hoa",
    approverTime: "09:40",
  },
};
